...
Применение BERT для исправления опечаток и грамматических ошибок в русскоязычных текстах.
...
Для русского языка была использована похожая метрика, только F1, но вот скоринг был устроен иначе. Там выравнивались исходное и исправленное предложения и так уже находились исправления. Код самого скорера я пока не нашел, возможно, можно использовать ERRANT/MaxMatch скореры, так как они открыты.
